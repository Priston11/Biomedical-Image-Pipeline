...
python3 main.py
Generated Artifacts
Upon successful execution, the following outputs are automatically generated and committed to the repository:

Task1_EDA_plot.png: Exploratory data analysis intensity distribution histogram.

Task3_UNet_panels.png: Side-by-side visualization panel of input images, ground truth masks, and U-Net predictions.

hybrid_pipeline_test_summary.csv: Aggregated end-to-end test set summary table across all unseen evaluation samples.
